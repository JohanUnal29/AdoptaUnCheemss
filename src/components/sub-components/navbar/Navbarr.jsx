    ...
    <Navbar className="nav-grande" bg="transparent" expand="lg">
      <Container fluid style={{ paddingLeft: '100px', paddingRight: '100px' }}>
        <div className="logo-container">
          <Navbar.Brand>
            <Link to="/">
              <a className="navbar-brand col-6" href="./index.html">
                <img className="logotipo" src="https://drive.google.com/uc?export=download&id=1924cU6mFI_lXAvhY7VAPks-9TgXW0Kmu" alt="Logo de Dasein" />
              </a>
